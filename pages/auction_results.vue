  ...
  <div>
    <div class="mainContent">
      <el-breadcrumb class="location container" separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item class="current">Auction Results</el-breadcrumb-item>
      </el-breadcrumb>

      <section class="container auctionsList">
          <h2 class="heading-l">Auction Results</h2>
          <div class="auctionsList__list" v-if="data.length > 0">
            <div class="item" v-for="(item,index) in data" :key="index">
                <el-row :gutter="30">
                    ...
                    <el-col :span="13" xs="17" style="display: flex; justify-content: space-between;">
                        <div>
